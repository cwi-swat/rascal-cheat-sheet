...
\noindent\url{https://github.com/cwi-swat/rascal}
\end{minipage}
\begin{minipage}{0.3\linewidth}
%\includegraphics[width=1\linewidth]{logorascal}
...
\CAT{Keyword}{for} (i \textless{}- {}[\CAT{Keyword}{0}..10]) S; \CAT{Comment}{// Loop 10 times}
...
( \CAT{Keyword}{0} | \CAT{Keyword}{it} + i | i \textless{}- {}[1..10] ); \CAT{Comment}{// reducing}
...
'  \textless{}}\CAT{Keyword}{if} (i \%{} 2 == \CAT{Keyword}{0}) \{{}\CAT{Constant}{\textgreater{}
